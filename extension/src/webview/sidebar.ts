...
<script>
  ...
  <button class="btn primary" data-cmd="missioncontrol.orchestratorNew">▶ Orchestrator — เริ่มใหม่</button>
  <button class="btn primary" data-cmd="missioncontrol.orchestratorContinue">⏮ Orchestrator — ทำต่อ</button>
